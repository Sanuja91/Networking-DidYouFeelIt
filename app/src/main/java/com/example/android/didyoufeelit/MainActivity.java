...
public class MainActivity extends AppCompatActivity {
    ...
    private class EarthquakeAsyncTask extends android.os.AsyncTask<String, Void, Event> {


        /**
         * This method is invoked on a background thread, so we can perform
         * long running operations like making a network request.
         * It is NOT okay to update the UI from a background thread, so we jusst return
         * an @{link Event} object as the result.
         */
        ...
        /**
         * This method is invoked on the main UI thread after the background wor has been completed
         * <p/>
